...
<body>
	<div class="wrapper">
		<div class="regContainer">
			...
			<form:form
				class="container p-3 bg-light col-6 d-inline-block align-top"
				method="POST" action="/registration" modelAttribute="user">
				<p>
				...
				<div class="form-group row">
					<form:label path="passwordConfirmation"
						class="col-sm-2 col-form-label">Confirm Password:</form:label>
