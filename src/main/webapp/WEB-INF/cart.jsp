							...
							<div class="card-header  text-light"
								...
								<p>
									<a href="/productList"
										...
										style="background-color: #F9E7E7; color: black; border: none; font-size: 16px">Continue
										shopping</a>
								</p>
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<c:forEach var="product" items="${sessionScope.cart}">
										...
										<c:set var="subtotal"
											value="${subtotal + i.price * product.getValue()}"></c:set>
										...
										<div class="col-12 col-sm-12 col-md-2 text-center">
											<img class="img-responsive"
												src="<c:out value="${i.pictureUrl}"/>" alt="prewiew"
												width="120" height="80">
										</div>
										<div
										...
										<div
											...
											<div class="col-4 col-sm-4 col-md-4">
												<div class="quantity">
													<a href="/cart/<c:out value="${i.id}"/>"><input
														type="button" value="+" class="plus"></a> <input
											...
											<div class="form-group">
												...
												<div class="col-md-6 col-xs-12">
													<strong>Last Name:</strong> <input type="text"
														name="last_name" class="form-control" value="" />
												</div>
											</div>
											<div class="form-group">
												<div class="col-md-12">
