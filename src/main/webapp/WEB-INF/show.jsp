		 ...
		 <img class="img" style="width:120px;height:80px" src="../img/mylogo.png">
		  ...
		  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
		    ...
		    <form class="form-inline my-2 my-lg-0">
		      ...
		      <input class="form-control mr-sm-2" type="search" style="background-color: #F9E7E7; color: black; border-color: white;"  placeholder="Search">
		      <button class="btn btn-outline-success my-2 my-sm-0"  style="border-color:pink; color: black" type="submit">Search</button>
		    </form>
		  </div>
		</nav>
		<div class="title"> 
		<h1 style="color: #E5CFCF; font-family: 'Petit Formal Script', cursive" >Welcome, <c:out value="${user.firstName}" /> <c:out value="${user.lastName}" /></h1>
		<br> 
...
<p class="price-detail-wrap"> 
	<span class="price h3 text-warning"> 
		<span class="currency">US $</span><span class="num"><c:out value="${product.price}"/></span>
	</span> 
	<span>/per item</span> 
</p> <!-- price-detail-wrap .// -->
<dl class="item-property">
  <dt>Description</dt>
  <dd><p><c:out value="${product.description}"/> </p></dd>
</dl>
...
<hr>
	...
	<hr>
	<a href="/cart/${id}" class="btn btn-lg btn-primary text-uppercase" style="background-color: pink; border:none;"> Buy now </a>
	<a href="/cart/${id}" class="btn btn-lg btn-outline-primary text-uppercase" style="border-color: pink; color: gray"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
</article> <!-- card-body.// -->
		</aside> <!-- col.// -->
	</div> <!-- row.// -->
</div> <!-- card.// -->
...
<!-- <article class="bg-secondary mb-3" >  
 --><div class="card-body text-center">
    <h4 class="text-black">Lele rose <br> </h4>
<p class="h5 text-black"> If you're particularly strapped for time, we can customize gifts to add a personal touch to any of your gift!</p>   <br>
<p><a class="btn btn-warning" style="background-color:#E5E7E9; border:none; color: black" target="_blank" href="/home"> LeleRose.com  
