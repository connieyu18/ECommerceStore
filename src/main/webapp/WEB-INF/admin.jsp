...
<div class="wrapper"> 
 <h2><a href="/productList">Back to product page</a></h2>
	<div class="container">
...
<%--   <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
	...
	<table class="table table-striped table-bordered table-hover dark">
		...
		<tr>
		<td><span><strong><c:out value="${i.getId() }"/> </strong></span></td>
		<td><a href="/products/${i.getId() }"><c:out value="${i.getName() }"/></a></td>
		<td><c:out value="${i.getDescription() }"/></td>
		<td><c:out value="${i.getCategory() }"/></td>
		<td>$<c:out value="${i.getPrice() }"/>0</td>
		<td><img  class="img-fluid" style= "width: 100px; height: 100px; float: center" src="<c:out value="${i.getPictureUrl()}"/>"/></td>
		<td><p><button type="button" class="btn btn-light btn-sm" data-toggle="modal" data-target="#myModal">Edit Product</button></p>
		  ...
		  <div class="modal fade" id="myModal" role="dialog">
		    <div class="modal-dialog">
		      ...
		      <div class="modal-content">
		        ...
		        <div class="modal-body">
					<form:form action="/editProduct/${i.getId() }" method="post" modelAttribute="product">
				    <div class="form-group row">
				        <form:label path="name" class="col-sm-3 col-form-label">Product Name:</form:label>
				        <form:errors path="name"/>
				        <div class="col-sm-6">
		...
		<p><a href="/products/${i.getId()}/delete">Delete</a></p>
